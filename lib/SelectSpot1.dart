...
import './SelectSpot2.dart';
import 'package:adobe_xd/page_link.dart';
import 'dart:ui' as ui;
import 'package:flutter_svg/flutter_svg.dart';

class SelectSpot1 extends StatelessWidget {
  SelectSpot1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(129.0, 132.0, 118.0, 24.0),
            size: Size(375.0, 812.0),
            pinTop: true,
            fixedWidth: true,
            fixedHeight: true,
            ...
            child: PageLink(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 32.0, 70.0, 21.0),
                    size: Size(172.0, 86.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(44.0, 32.0, 84.0, 21.0),
                  size: Size(172.0, 86.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Pinned.fromSize(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(56.0, 32.0, 60.0, 21.0),
                  size: Size(172.0, 86.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
