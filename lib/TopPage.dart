...
import 'package:auto_tour_planning_flutter/FavoriteSpot.dart';
import 'package:auto_tour_planning_flutter/Profile.dart';
import 'package:auto_tour_planning_flutter/PlanList1.dart';
import 'package:auto_tour_planning_flutter/SelectPurpose1.dart';
import 'package:auto_tour_planning_flutter/SelectSpot1.dart';
import 'package:auto_tour_planning_flutter/SpotDetail.dart';
          ...
          child: new Row(
            ...
            children: <Widget>[
              ...
              IconButton(
                ...
                color: const Color(0xF4C5264).withOpacity(1),
                onPressed: () {
                  Navigator.push(
                    context,
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => FavoriteSpot(),
                      )
                  );
                },
              ),
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => SelectPurpose1(),
                            )
                        );
                      },
                      child: Text(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(60.0, 7.0, 215.0, 24.0),
...
const String _svg_img_bluepinn =
...
const String _svg_img_users =
    '<svg viewBox="5.3 13.6 5.0 5.3" ><path  d="M 10.30000019073486 13.60000038146973 L 10.30000019073486 16.60000038146973 L 5.300000190734863 18.89999961853027" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
...
const String _svg_img_home =
    '<svg viewBox="0.5 0.5 19.4 7.6" ><path  d="M 17.5 8.100000381469727 L 19.89999961853027 8.100000381469727 L 10.19999980926514 0.5 L 0.5 8.100000381469727 L 2.5 8.100000381469727" fill="none" stroke="#FFFFFF" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
