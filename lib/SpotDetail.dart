    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Container(),
          Pinned.fromSize(
            bounds: Rect.fromLTWH(10.0, 108.0, 355.0, 240.0),
            ...
            child:
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: const AssetImage('assets/images/cave_of_blue.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(159.0, 366.0, 70.0, 10.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Stack(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(20.0, 395.0, 107.0, 37.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(20.0, 451.0, 117.0, 49.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
            child: Stack(
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(21.0, 0.0, 96.0, 21.0),
                  size: Size(117.0, 49.0),
                  pinRight: true,
                  pinTop: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(21.0, 30.0, 94.0, 19.0),
                  size: Size(117.0, 49.0),
                  pinRight: true,
                  pinBottom: true,
                  fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(1.0, 1.0, 15.0, 20.0),
                  size: Size(117.0, 49.0),
                  pinLeft: true,
                  pinTop: true,
                  fixedWidth: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 31.0, 18.0, 18.0),
                  size: Size(117.0, 49.0),
                  pinLeft: true,
                  pinBottom: true,
                  fixedWidth: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(20.0, 530.0, 335.0, 60.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
            child: Stack(
              children: <Widget>[
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(0.0, 0.0, 335.0, 60.0),
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(61.0, 18.0, 214.0, 24.0),
                  size: Size(335.0, 60.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(20.0, 620.0, 335.0, 160.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            pinRight: true,
            pinBottom: true,
            ...
            child:
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/map_sample.jpg'),
                  fit: BoxFit.cover,
                ),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(307.0, 390.0, 48.0, 48.0),
            size: Size(375.0, 812.0),
            pinRight: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(317.0, 403.0, 27.3, 22.4),
            size: Size(375.0, 812.0),
            pinRight: true,
            fixedWidth: true,
            fixedHeight: true,
